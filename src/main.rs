...
struct Args {
	...
	#[clap(
		short,
		long,
		default_value = "https://github.com/EGA-archive/beacon-v2/models/json/beacon-v2-default-model"
	)]
	model: Url,

	/// Location of the framework
	#[clap(short, long, default_value = "https://github.com/EGA-archive/beacon-v2/framework/json")]
	framework: Url,
